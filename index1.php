...
if (!isset($_SESSION['Email1']) && !isset($_SESSION['hosname'])) {
...
<html lang="en">
  ...
  <head>
    ...
    <title>Emergency Response Application ~ Hospital Homepage</title>
...
<body>
  ...
  <header class="main-header clearfix" role="header">
    <div class="logo">
      <a href="#"><em>Emergency</em> Response</a>
    </div>
    <a href="#menu" class="menu-link"><i class="fa fa-bars"></i></a>
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        <li><a href="#section1">Home</a></li>
        <li><a href="#section2">Hospital Actions</a></li>
  ...
  <section class="section main-banner" id="top" data-section="section1">
      ...
      <div class="video-overlay header-text">
          <div class="caption">
              ...
              <h2><em>Welcome </em> to <?php echo $row['Hospital_Name']; ?></h2>
    ...
    <div class="container">
      <div class="row">
        <div class="continer centerIt">
            <div>
              <h4>Get started with your <em>HOSPITAL</em> Actions</h4>
            </div>
          </div>
        <div class="col-md-12">
          <div class="right-content">
            <div class="top-content">
              <h6>Update an <em>Emergency Response</em> by use of this form:</h6>
            </div>
            <form id="contact" action="insertion.inc.php" method="post">
                <div class="col-md-12">
                  <fieldset>
                    <input name="rid" type="text" class="form-control" id="email1" placeholder="ER ID" required="">
                  </fieldset>
                </div>
                  <div class="col-md-12">
                  <fieldset>
                    <select name="stat" class="form-control" id="email" required="">
                      <option value="" selected="" disabled="">Select Status of ER</option>
                ...
                <div class="col-md-12">
                  <fieldset>
                    <button type="submit" id="form-submit" name="upa" class="button">Update</button>
                  </fieldset>
                </div>
              </div>
            </form>
...
$hid = $_SESSION['hosname'];
$sql = "SELECT `Emergency_ID`, `Patient_ID`, `Hospital_ID`, `Medical_Services`, `Prior_Medical_Condition`, `Blood_Type`, `Time`, `Location`, `Status` FROM `emergency_response` WHERE `Hospital_ID` = '$hid'";
