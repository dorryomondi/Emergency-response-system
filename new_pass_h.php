  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        ...
        <li><a href="#section3">New Password</a></li>
        ...
        <div class="col-md-12">
          <div class="right-content">
            <div class="top-content">
              <h6>Kindly input your <em>New Password</em> to complete the process:</h6>
            </div>
            <form id="contact" action="insertnewpass1.php" method="post">
                <div class="col-md-12">
                  <fieldset>
                    <input name="password" type="password" class="form-control" id="pass" placeholder="Your New Password" required="">
                    <a onclick="myFunction();" style="color: white;"> Show Password</a>
                  </fieldset>
                </div>
                <div class="col-md-12">
                  <fieldset>
                    <input name="cpassword" type="password" class="form-control" id="pass1" placeholder="Confirm Your New Password" required="">
