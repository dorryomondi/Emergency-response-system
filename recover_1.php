  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        ...
        <li><a href="#section3">Reset Password</a></li>
        ...
        <div class="col-md-12">
          <div class="right-content">
            <div class="top-content">
              <h6>Kindly input your <em>Email Address and Module</em> to proceed:</h6>
            </div>
            <form id="contact" action="find_email.php" method="post">
                <div class="col-md-12">
                  <fieldset>
                    <input name="email" type="text" class="form-control" id="email1" placeholder="Your Email Address" required="">
                  </fieldset>
                </div>
                  <div class="col-md-12">
                  <fieldset>
                    <select name="mod" class="form-control" id="email" required="">
                      <option value="" selected="" disabled="">Select Your Module</option>
